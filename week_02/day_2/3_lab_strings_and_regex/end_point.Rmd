...
Q3: Is Julia ever mentioned by name?
...
Q6: Replace Victory Gin with Victory Vodka
...
replace_with3 <- " VODKA "
test <- whole_text %>% 
  str_replace(c(pattern1, pattern2, pattern3),
              c(pattern1 = replace_with1,
                pattern2 = replace_with2,
                pattern3 = replace_with3))
```
