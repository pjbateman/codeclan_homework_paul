...
```
Given the low p-value, we reject the null hypothesis: the mean `sleep_total` in the sampled population of animal types does differ statistically from the typical value for jabberwockies (7 hours).

**Question 3.**  
Perform an appropriate statistical test to determine whether omnivores sleep for significantly longer than herbivores, on average.

<br>
H0: mu_omnivore - mu_herbivore = 0
Ha: mu_omnivore - mu_herbivore > 0
alpha: 5%
...
q3_p_value
```
The large p-value of 0.128 exceeds our alpha level of 0.05, so we do not reject the null hypothesis.  So there is no statistical difference between the mean amount of time that omnivore and herbivore mammals sleep.
...
Answer:
H0: pie prop_domestic = 0.05
H1: pie prop_domestic > 0.05
alpha: 5%
...
```
The low p-value of 8e-04 leads us to reject the null hypothesis in favour of the alternative hypothesis, that the proportion of domestic animal types is greater than 5%.
...
Answer:
I would use a one-sided one-sample proportion test.
H0: pie_prop_know = 0.4
HA: pie_prop_know > 0.4
The null hypothesis is that 40% of those the town's population know of the coffee shop.
The alternative hypothesis is that more than 40$ of the the town's population know of the coffee shop.
A simulation method would be used to generate the null distribution.
...
<br>
Answer:
I would use a one-sided two-sample proportion test.
H0: pie_CTR_groupB - pie_CTR_groupA = 0
HA: pie_CTR_groupB - pie_CTR_groupA > 0
The null hypothesis is that the CTR is the same for both groups.
The alternative hypothesis is that the mean CTR of groupB exceeds that of groupA.
A permute method would be used to generate the null distribution.
...
Answer:
I would use a two-sided one-sample mean test.
H0: μ0 = 145
HA: μ0 =! 145
The null hypothesis is that the population mean width is 145mm.
The alternative hypothesis is that the population mean width is statistically different from 145mm.
A bootstrap method would be used to generate the null distribution.
...
<br>
Answer:  we fail to reject the null hypothesis as the p-value exceeds the alpha level.  So we conclude it is possible that 40% of the town's population know of the coffee shop.
...
<br>
Answer: we reject the null hypothesis in favour of the alternative hypothesis, since the p-value is less than the alpha level.  So we conclude that the new banner placement location does result in a higher CTR.

**Question 3.**  

**Manufacturing company problem**. Significance level: 0.05, $p$-value: 0.55
Answer: we fail to reject the null hypothesis as the p-value exceeds the alpha level. So, we conclude that the population mean width does not differ statistically from 145mm and that quality drift does not appear to have set in the manufacturing process.
